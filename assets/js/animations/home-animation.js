...
// tl.to('.stechdigital', 1.5, {scaleY: 1, height: '100vh', ease: Circ.easeOut})
// tl.to('.stechdigital-title', 1, {opacity: 1, y: 0, delay: 1, ease: Back.easeOut.config(1.7)}, 1)
...
gsap.to('.strategies-text', {
    y: 0
});

// OUR-STRATIGY ANIMATION END